...
_BASE="runs/vton_20260623_124510/latest"
...
export LAMBDA_BG_CHROMA=4.0 BG_TARGET_BAND=80
# (2) FLATNESS / kill blotchiness: match each bg pixel to a smooth inpainted bg-field target.
export LAMBDA_BG_FIELD=2.0 BG_FIELD_KSIZE=61 BG_FIELD_SIGMA=24
# (3) Lab a,b color match in the bg shell around the body (reinforce neutral color).
export LAMBDA_BG_SHELL_AB=1.0 BG_SHELL_DIL_PX=30 BG_SHELL_SIGMA_GATE=0.6
...
export NUM_EPOCHS=2 TIME_BUDGET=54000 MAX_STEPS=500000
export SAVE_PER_EPOCH=0 VAL_PER_EPOCH=0 SAVE_EVERY_STEPS=0 VAL_EVERY_STEPS=0 SAVE_EVERY_VAL=1
export SAVE_EVERY_SECONDS=5400   # 1.5h (verified working)
