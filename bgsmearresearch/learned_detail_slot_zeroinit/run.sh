...
export RUN_NAME="${RUN_NAME:-RUN4B_DETAILSLOT}"   # RUN4B: detail_slot is now ZERO-INIT (step0 == run37)
...
export USE_GARMENT_ADAPTER=1 GARMENT_ADAPTER_MODE=detail_slot GARMENT_ADAPTER_LR=1e-4 
...
mkdir -p logs runs
RESDIR="bgsmearresearch/learned_detail_slot_zeroinit"; mkdir -p "$RESDIR"; LOG="${ADAPTER_LOG:-$RESDIR/${RUN_NAME}.log}"
