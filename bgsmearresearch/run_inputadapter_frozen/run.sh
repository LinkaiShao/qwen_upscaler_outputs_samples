...
export RUN_NAME="${RUN_NAME:-RUN1_INPUTADAPTER}"
...
export USE_GARMENT_ADAPTER=1 GARMENT_ADAPTER_MODE=input_hidden GARMENT_ADAPTER_LR=1e-4
...
export FREEZE_LORA=1 FREEZE_V6=1 USE_PCGRAD=0
...
mkdir -p logs runs
RESDIR="bgsmearresearch/run_inputadapter_frozen"; mkdir -p "$RESDIR"; LOG="${ADAPTER_LOG:-$RESDIR/${RUN_NAME}.log}"
