# latenttoken_adapter — Latent-Token Detail Adapter

**Mode** `GARMENT_ADAPTER_MODE=latent_token`. Inject in PACKED 64-d token space inside _fwd: C_pack += M*zero_init_64d_adapter(aligned garment). Train 64d adapter + LoRA, v6 frozen.
