...
export RUN_NAME="${RUN_NAME:-RUN5_SPATIAL_ADALN}"
...
export USE_GARMENT_ADAPTER=1 GARMENT_ADAPTER_MODE=spatial_adaln GARMENT_ADAPTER_LR=1e-4 GARMENT_ADAPTER_BLOCKS="12,20,28,36"
...
mkdir -p logs runs
RESDIR="bgsmearresearch/spatial_adaln"; mkdir -p "$RESDIR"; LOG="${ADAPTER_LOG:-$RESDIR/${RUN_NAME}.log}"
