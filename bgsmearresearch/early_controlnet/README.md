# early_controlnet — Early ControlNet Residual

**Mode** `GARMENT_ADAPTER_MODE=controlnet`. Qwen side branch -> masked zero-init residuals residual=M*zero_init_proj(gnet_feat) into early/mid blocks 8,16,24,32. Train side branch + residual heads + LoRA, v6 frozen.
